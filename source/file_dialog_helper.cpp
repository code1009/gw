...
//	ZeroMemory(_ofn_open_szTitle     , sizeof(_ofn_open_szTitle     ));
	...
	ofn.nMaxFileTitle   = NULL; //sizeof(_ofn_open_szFileTitle) / sizeof(_ofn_open_szFileTitle[0]); 
	...
	ofn.nFilterIndex    = (NULL==ofn.lpstrFilter) ? 1 : 0;;
...
//	ZeroMemory(_ofn_save_szTitle     , sizeof(_ofn_save_szTitle     ));
	...
	ofn.nMaxFileTitle   = NULL; // sizeof(_ofn_save_szFileTitle) / sizeof(_ofn_save_szFileTitle[0]); 
